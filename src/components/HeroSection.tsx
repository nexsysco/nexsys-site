...
const HeroSection: React.FC = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-blue-50 pt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-800"> soluções digitais</span>
          </h1>

          {/* Subheading */}
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            A Nexsys oferece consultoria especializada em tecnologia, ajudando empresas a
            inovarem, otimizarem processos e alcançarem seus objetivos através de soluções
            tecnológicas personalizadas e eficientes.
          </p>
